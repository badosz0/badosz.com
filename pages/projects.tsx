            ...
            <Layout section="projects">
                <div className="flex justify-center items-center flex-col mt-20">
                    ...
                    <Project
                        name="Salio"
                        links={[
                            ["Steam", "https://store.steampowered.com/app/875810/Salio/"],
                            ["Discord", "/discord"],
                        ]}
                    ...
                    <Project
                        name="Dear President,"
                        links={[
                            ["Itch", "https://badosz.itch.io/dear-president"],
                            ["Discord", "/discord"],
                        ]}
                    ...
                    <Project
                        name="Curfe"
                        links={[
                            ["Itch", "https://badosz.itch.io/curfe"],
                            ["Discord", "/discord"],
                        ]}
                    ...
                    <Project
                        name="Satan's Island"
                        links={[
                            ["Itch", "https://badosz.itch.io/satans-island"],
                            ["Discord", "/discord"],
                        ]}
